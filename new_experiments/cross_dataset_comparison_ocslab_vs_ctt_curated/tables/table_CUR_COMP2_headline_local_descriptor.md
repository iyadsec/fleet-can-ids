# table_CUR_COMP2_headline_local_descriptor
              ...
              local ROC-AUC                      0.7855                                    0.9944 Comparable with caveat Descriptive cross-dataset comparison; datasets differ in vehicles, attacks, and splits.
               local PR-AUC                      0.9273                                    0.0978 Comparable with caveat Descriptive cross-dataset comparison; datasets differ in vehicles, attacks, and splits.
            local precision                      0.9728                                    0.0227 Comparable with caveat Descriptive cross-dataset comparison; datasets differ in vehicles, attacks, and splits.
               local recall                      0.4596                                    0.2500 Comparable with caveat Descriptive cross-dataset comparison; datasets differ in vehicles, attacks, and splits.
                   local F1                      0.6243                                    0.0417 Comparable with caveat Descriptive cross-dataset comparison; datasets differ in vehicles, attacks, and splits.
                  local FPR                      0.0395                                    0.1738 Comparable with caveat Descriptive cross-dataset comparison; datasets differ in vehicles, attacks, and splits.
