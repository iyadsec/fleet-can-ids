...
See `paper/figures/figure_05_cross_vehicle_embedding.pdf` (and `figures/descriptor_embedding_by_attack.pdf` when regenerated). Attack-coloured views should show attack-type groupings spanning multiple vehicle markers.
